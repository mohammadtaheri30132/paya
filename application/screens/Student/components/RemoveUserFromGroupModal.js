...
const RemoveUserFromGroupModal = ({isModalVisible,setModalVisible}) => {
    const toggleModal = () => {
    ...
    return (
        ...
        >
            <View style={{
                ...
                <ROW mt={scale(5)}></ROW>
                <Br/>
                <ROW mt={scale(10)} row aligncenter justifycenter>
                    <SubText title='Do you want remove '/>
                    <SubText color='#002a32' title='Mohammad Taheri'/>
                </ROW>
                <ROW row aligncenter justifycenter>
                    <SubText title='from '/>
                    <SubText color='#002a32' title=' Group 1'/>
                </ROW>
